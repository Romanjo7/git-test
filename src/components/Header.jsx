...
export const Header = memo(({ cart, displayCart, totalPrice, setTotalPrice }) => {
            ...
            <div className="app_header_wrapper">
                <div className="app_header_content">
                    <Link to={`${BASE_URL}/`} className="logo_section">
                        ...
                        <div className="logo_section-text">
                    ...
                    <div className="app_header_links">
                        <a
                            className="app_header_links_cart"
                            onClick={displayCart}
                        >
                            <svg width="20" height="20" viewBox="0 0 20 20" alt="cart_logo" className="cart_logo" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="cart_text">{
                                `${totalPrice} руб.`.replace(/\B(?=(\d{3})+(?!\d))/g, " ")
                            }
                            </span>
                        </a>
                        <Link to={`${BASE_URL}/favorites`} className="app_header_links_favorites">
                            <svg width="22" height="19" viewBox="0 0 22 19" alt="favorites_logo" className="heart_logo" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="cart_text">Закладки</span>
                        </Link>
                        <Link to={`${BASE_URL}/purchases`} className="app_header_links_purchases">
                            <svg width="20" height="20" viewBox="0 0 20 20" alt="user_logo" className="user_logo" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="cart_text">Профиль</span>
                        </Link>
                    </div>
                </div>
            </div>
